...
/* harmony import */ var _projectInsertStorage__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./projectInsertStorage */ "./src/projectInsertStorage.js");
...
function projectListener() {
    ...
    content.addEventListener('dblclick', (e) => {
        ...
        if (e.target.id.includes('projectN')) {
            ...
            ;(0,_projectInsertStorage__WEBPACK_IMPORTED_MODULE_6__.insertStoredTasks)(projectIDnumber)
        }
    ...
    content.addEventListener('click', (e) => {
        ...
        if (taskDash != null) {
            ...
            e.target.parentElement.id.includes('returnB')) {
                ...
                let storedProjects = (0,_projectStorage__WEBPACK_IMPORTED_MODULE_6__.projectStorage)('read')
